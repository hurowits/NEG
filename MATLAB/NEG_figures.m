...
hold on;
% grid on
h1=plot(linspace(0,5,100),squeeze(numComplex1(15:end,1,:)),'r','LineWidth',2);
h2=plot(linspace(0,5,100),squeeze(numComplex1(15:end,2,:)),'b','LineWidth',2);
h3=plot(linspace(0,5,100),squeeze(numComplex(15:end,1,:)),':r','LineWidth',1);
h4=plot(linspace(0,5,100),squeeze(numComplex(15:end,2,:)),':b','LineWidth',1);
% set(h3,'Color',[.5,0,0])
% set(h4,'Color',[0,0,0.5])
for iSigma = 1:2
