...
ind2 = ind(1:10);
[kappa,signKappa,expKappa,E_vec] = thoulessKappa([ epsilon(ind)],N,g,[ epsilon]);
[kappa2,signKappa2,expKappa2,E_vec2] = thoulessKappa([ epsilon(ind2)],N,g,[ epsilon]);
...
axis([-0 2000 -10 40])
% print(gcf, '-depsc2', ['/Users/danielhurowitz/PROJ/NEG/Figs/gRing_ES_vs_cont2.eps'])
%%
