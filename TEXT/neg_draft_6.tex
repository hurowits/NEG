...
\begin{figure*}
\includegraphics[height=4.5cm]{/Figs/V_E_1_2b.eps}
\includegraphics[height=4.5cm]{/Figs/V_E_1b.eps}
\includegraphics[height=4.5cm]{/Figs/V_E_2b.eps}

\includegraphics[height=4.5cm]{/Figs/spectrum_electrostatics1_2.eps}
\includegraphics[height=4.5cm]{/Figs/spectrum_electrostatics1.eps}
\includegraphics[height=4.5cm]{/Figs/spectrum_electrostatics2.eps}
\caption{
Illustrating the route to complexity. 
The top row shows the electrostatic potential $V(\epsilon)$ along the real axis
 and the bottom row shows the associated spectrum (green points) in the complex plane. 
 The colour background is the value of the electrostatic potential, the color code is such that $V(0)$ is white. The closed contours are equipotential lines and the and the open lines are the field lines. The thick gray points are the charges $\epsilon_k$.
...
\includegraphics[height=5cm]{/Figs/s_c_vs_alpha.eps}
...
\includegraphics[height=5.4cm]{/Figs/numComplex_100_alpha_sigma}
%\includegraphics[height=5cm]{/Figs/numComplex_500}
\caption{
We count the number of complex eigenvalues
for a ring with $N=100$ sites, for various values of the affinity $s$. Each red line corresponds to a different
...
We have shown that the spectral scenario emerging from a conservative rate equation with a closed topology
is dramatically different from that of a non conservative rate equation. 
In our analysis we used a procedure proposed by Hatano and Nelson, which we employed 
to bridge between the phenomena of percolation, localization and Sinai diffusion. 
