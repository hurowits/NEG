...
The outer thick line the steady-state distribution (see Methods). 
% \Ap{Ap12}
}
\end{figure*}
...
The black line is $S_c=M\sigma$. %\Eq{e33}. 
%
...
from the roots $\epsilon_k$ of the $S_{\circlearrowleft}{=}0$ equation. 
